...
- Emissão de senhas com interface colorida usando códigos ANSI  
...
Foi desenvolvido como trabalho de programação em **C++**, aplicando conceitos de **orientação a objetos**, **vetores dinâmicos** e manipulação de arquivos.
 ...
 Funcionalidades
1. Emitir nova senha para o cliente  
2. Chamar próximo cliente da fila  
3. Mostrar estatísticas do atendimento diário  
4. Registrar atendimentos em arquivo para consulta futura  
